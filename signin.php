...
<div class="w-screen min-h-screen bg-gray-100 grid place-content-center">
    <div class="bg-white rounded-md px-10 py-8">
        ...
        <form action="signin.php" method="POST" class="flex flex-col gap-4" enctype="multipart/form-data" onsubmit="return validatePassword()">
            ...
            <div>
                <input type="submit" name="signin" class="border-2 cursor-pointer border-indigo-600 bg-indigo-600 text-white px-6 py-4 w-full rounded-md hover:bg-transparent hover:text-indigo-600 font-semibold" value="Sign In" />
            </div>
        </form>
